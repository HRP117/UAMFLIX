...
public class GERENTE_ALTA_BAJA_1_ALTA extends javax.swing.JFrame {
    ...
    public GERENTE_ALTA_BAJA_1_ALTA() {
        ...
        op = new OyentePersonal(BAJA, REGISTRAR, REGRESAR, this);
        REGRESAR.addActionListener(op);
        BAJA.addActionListener(op);
        REGISTRAR.addActionListener(op);
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("ID_PROYECTO");
        Opcion_ALTA.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 140, 30));
        ...
        REGISTRAR.setForeground(new java.awt.Color(201, 45, 57));
        ...
        Opcion_ALTA.add(telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, 250, 30));
        Opcion_ALTA.add(tarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 330, 250, 30));
        ...
        Opcion_ALTA.add(contrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 250, 250, 30));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel13.setText("CONTRASEÑA:");
        Opcion_ALTA.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 140, 30));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setText("NUMERO TARJETA");
        Opcion_ALTA.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 140, 30));
    ...
    private void REGISTRARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_REGISTRARActionPerformed
        ...
        if(tarjeta.getText().equals("")||telefono.getText().equals("")||correo.getText().equals("")||nickname.getText().equals("")||nombre.getText().equals("")){
           ...
           //ga.registrar(cliente);
            ...
            cliente.setContraseña(telefono.getText());
            cliente.setCorreo(correo.getText());
            cliente.setNickname(nickname.getText());
            cliente.setTelefono(telefono.getText());// FALTO TELEFONO
